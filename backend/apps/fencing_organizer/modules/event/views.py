...
class EventViewSet(viewsets.GenericViewSet):
    ...
    def get_permissions(self):
        if self.action in ['create', 'list', 'retrieve', 'update', 'partial_update', 'destroy',
                           'by_tournament', 'update_live_ranking', 'get_participants',
                           'sync_participants', 'stage_pools', 'stage_detree']:
            return [AllowAny()]
    ...
    def stage_pools(self, request, pk=None, stage_id=None):
        ...
        if request.method == 'GET':
            ...
            try:
                ...
                return Response({"message": f"Successfully saved {len(new_pools)} pools to stage {stage_id}"},
