...
PREDEFINED_ELIMINATION_TYPES = [
    {"type_code": EliminationTypeCode.SINGLE_ELIMINATION, "display_name": "单败淘汰"},
    {"type_code": EliminationTypeCode.DOUBLE_ELIMINATION, "display_name": "双败淘汰"},
    {"type_code": EliminationTypeCode.ROUND_ROBIN_ONLY, "display_name": "仅循环赛"},
]

# 预定义排名类型
PREDEFINED_RANKING_TYPES = [
    {"type_code": RankingTypeCode.BRONZE_MATCH, "display_name": "有铜牌赛"},
    {"type_code": RankingTypeCode.ALL_RANKS, "display_name": "所有排名"},
    {"type_code": RankingTypeCode.NO_THIRD_PLACE, "display_name": "无铜牌赛"},
]
