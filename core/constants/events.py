...
PREDEFINED_EVENT_STATUSES = [
    {"status_code": EventStatusCode.SCHEDULED, "display_name": "已安排"},
    {"status_code": EventStatusCode.POOL_ROUND, "display_name": "小组赛阶段"},
    {"status_code": EventStatusCode.ELIMINATION_ROUND, "display_name": "淘汰赛阶段"},
    {"status_code": EventStatusCode.COMPLETED, "display_name": "已完成"},
    {"status_code": EventStatusCode.CANCELLED, "display_name": "已取消"},
]
