...
class Match:
    ...
    match_code: str = field(metadata={"max_length": 20, "description": "比赛编号 (NOT NULL, UNIQUE)"})
    ...
    fencer_a_id: Optional[UUID] = field(default=None, metadata={"foreign_key": "Fencer", "description": "运动员A"})
    fencer_b_id: Optional[UUID] = field(default=None, metadata={"foreign_key": "Fencer", "description": "运动员B"})
    ...
    forfeit_type_id: Optional[UUID] = field(default=None, metadata={"foreign_key": "Forfeit_Type", "description": "退赛类型"})
    ...
    updated_at: datetime = field(default_factory=datetime.now, metadata={"description": "更新时间", "db_default": "NOW()"})
