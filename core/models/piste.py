...
class Piste:
    ...
    piste_number: str = field(metadata={"max_length": 10, "description": "剑道编号 (NOT NULL, UNIQUE)"})
    ...
    piste_type: Optional[str] = field(default=None,
                                      metadata={"max_length": 20, "description": "类型：MAIN, SIDE, WARMUP"})
