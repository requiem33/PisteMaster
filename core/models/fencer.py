...
class Fencer:
    ...
    display_name: Optional[str] = field(
        default=None, metadata={"max_length": 200, "description": "显示名称（姓+名）"}
    )
    gender: Optional[str] = field(
        default=None, metadata={"max_length": 10, "description": "性别"}
    )
    country_code: Optional[str] = field(
        default=None, metadata={"max_length": 3, "description": "IOC 代码 (CHAR(3))"}
    )
    birth_date: Optional[date] = field(
        default=None, metadata={"description": "出生日期"}
    )
    fencing_id: Optional[str] = field(
        default=None,
        metadata={
            "max_length": 50,
            "description": "国际击剑ID (UNIQUE)",
            "constraint": "UNIQUE",
        },
    )
    current_ranking: Optional[int] = field(
        default=None, metadata={"description": "当前世界排名"}
    )
    primary_weapon: Optional[str] = field(
        default=None, metadata={"max_length": 10, "description": "主剑种"}
    )
