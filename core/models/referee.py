...
class Referee:
    ...
    display_name: Optional[str] = field(
        default=None, metadata={"max_length": 200, "description": "显示名称"}
    )
    ...
    license_number: Optional[str] = field(
        ...
        metadata={
            "max_length": 50,
            "description": "裁判证号 (UNIQUE)",
            "constraint": "UNIQUE",
        },
    )
    license_level: Optional[str] = field(
        default=None, metadata={"max_length": 20, "description": "裁判等级"}
    )
